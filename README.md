...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/zuhasite-project)
...
3. Create a [D1 database](https://developers.cloudflare.com/d1/get-started/) with the name "zuhasite-project-database-d1":

```bash
npx wrangler d1 create zuhasite-project-database-d1
```
